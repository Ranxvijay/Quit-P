/* eslint-env browser */
// Patched version of @expo/metro-runtime/src/messageSocket.native.ts
// Fixes ESM/CJS interop: RN 0.81 exports these as ES modules (export default),
// so require() returns { default: fn } — we must access .default explicitly.
